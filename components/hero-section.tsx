...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-orange-50 to-green-50 dark:from-slate-900 dark:to-slate-800 py-20 md:py-32">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          <div className="flex flex-col gap-8">
            <div className="inline-flex items-center gap-2 rounded-full bg-orange-500/10 dark:bg-orange-500/20 px-4 py-2 text-sm font-medium text-orange-600 dark:text-orange-400 w-fit border border-orange-500/20 dark:border-orange-500/30">
            ...
            <h1 className="text-5xl font-bold leading-tight tracking-tight text-foreground md:text-6xl lg:text-7xl text-balance">
              당신만을 위한
              <br />
              <span className="text-orange-600 dark:text-orange-400">맞춤 취미</span>를
              <br />
              찾아드립니다
            </h1>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Button size="lg" className="text-lg font-semibold h-14 px-8 bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600" asChild>
                <Link href="/survey">
                  취미 추천받기
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="text-lg font-semibold h-14 px-8" asChild>
